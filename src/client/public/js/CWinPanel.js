function CWinPanel(oSpriteBg, bEnd) {
    ...
    this._init = function (oSpriteBg) {
        ...
        _oTitleTextStoke = new CTLText(_oGroup, 
                    CANVAS_WIDTH/2-300, (CANVAS_HEIGHT/2)-200, 600, 100, 
        ...
        _oNewScoreTextStroke = new CTLText(_oGroup, 
                    CANVAS_WIDTH/2-300, CANVAS_HEIGHT_HALF - 50, 600, iSizeFontSecondaryText, 
        ...
        _oBestScoreTextStroke = new CTLText(_oGroup, 
                    CANVAS_WIDTH/2-230, CANVAS_HEIGHT_HALF + 50, 460, iSizeFontSecondaryText, 
                    iSizeFontSecondaryText, "center", TEXT_COLOR_STROKE, FONT_GAME, 1,
                    0, 0,
                    " ",
                    true, true, false,
        ...
        _oButRestart = new CGfxButton(CANVAS_WIDTH * 0.5 + 200, CANVAS_HEIGHT * 0.5 + 130, oSpriteButRestart, _oGroup);
        ...
        _oButMenu = new CGfxButton(CANVAS_WIDTH * 0.5 - 200, CANVAS_HEIGHT * 0.5 + 130, oSpriteButHome, _oGroup);
        _oButMenu.addEventListener(ON_MOUSE_DOWN, this._onExit, this);

        // Leaderboard button (using info button sprite)
        var oSpriteButInfo = s_oSpriteLibrary.getSprite("but_info");
        _oButLeaderboard = new CGfxButton(CANVAS_WIDTH * 0.5, CANVAS_HEIGHT * 0.5 + 130, oSpriteButInfo, _oGroup);
        _oButLeaderboard.addEventListener(ON_MOUSE_DOWN, this._onShowLeaderboard, this);
    ...
    this.show = function (iScore) {
        ...
        this._saveScoreToLeaderboard(iScore);
    ...
    this._saveScoreToLeaderboard = function(iScore) {
        fetch('/api/save-score', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
            body: JSON.stringify({ score: iScore })
        })
    ...
    this._onShowLeaderboard = function () {
        var oLeaderboardPanel = new CLeaderboardPanel(s_oSpriteLibrary.getSprite("msg_box"));
        oLeaderboardPanel.show();
    };
