function GTMain(oData) {
    ...
    this._onRemovePreloader = function(){
        // _oPreloader.unload();
        if (this._oPreloader) { // Assuming _oPreloader is the variable holding the CPreloader instance
        this._oPreloader.unload();
        } else {
            console.warn("CPreloader object is undefined, cannot call unload.");
        }
